module Xively
  class Datastream
    ALLOWED_KEYS = %w(feed_id id feed_creator current_value datapoints
    max_value min_value tags unit_label unit_symbol unit_type updated
    datapoints_function real_id)
